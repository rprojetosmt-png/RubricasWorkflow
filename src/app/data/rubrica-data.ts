...
export interface RubricaRef {
  codigo: string; nome: string; tipo: "vantagem" | "desconto" | "auxiliar";
}
...
export const rubricaData = {
  codigo: "8055",
  informacoesGerais: {
    nome: "Adicional de Complexidade",
    orgao: "SEPLAG - Secretaria de Estado de Planejamento e Gestão",
    servidorResponsavel: "Maria Silva - Analista de RH",
    tipo: "Vantagem",
    dataInicio: "31/03/2024",
    paoe: "2024.001.123",
    grupoTrabalhista: "Servidor Público",
    categoriaTrabalhista: "Servidor Público Efetivo",
    outrosGrupos: "Não informado",
    cargosVinculados: ["Analista de Sistemas", "Técnico de TI"],
    baseLegal: "Lei Complementar nº 123/2024, Art. 15, § 2º",
  },
  incidencias: { gratificacaoNatalina: true, tercoFerias: true },
  naturezaVerba: { natureza: "Remuneratória", carater: "Contínuo", reterTeto: true },
  incidenciaTributaria: { temIncidencia: true, tributos: ["IRRF", "Previdência Própria"] },
};
